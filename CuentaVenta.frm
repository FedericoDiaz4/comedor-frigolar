...
Begin VB.Form CuentaVenta 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Cuenta Corriente - Ventas"
   ClientHeight    =   5040
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8775
   ...
   Begin VB.ComboBox cboCliente 
      ForeColor       =   &H00000000&
      Height          =   360
      ItemData        =   "CuentaVenta.frx":0B14
      Left            =   1320
      List            =   "CuentaVenta.frx":0B16
   ...
   Begin VB.ComboBox cboTipo 
      ForeColor       =   &H00000000&
      Height          =   360
      ItemData        =   "CuentaVenta.frx":10A2
      Left            =   6120
      List            =   "CuentaVenta.frx":10AC
      Style           =   2  'Dropdown List
      TabIndex        =   5
      TabStop         =   0   'False
      Top             =   360
   ...
   Begin VB.ComboBox cboIdCli 
      Height          =   360
      ItemData        =   "CuentaVenta.frx":10C5
      Left            =   4320
      List            =   "CuentaVenta.frx":10C7
      Style           =   2  'Dropdown List
      TabIndex        =   3
      Top             =   360
      Visible         =   0   'False
...
Sub calculaCtaCte()
    ...
    SQL = "SELECT * FROM ventas WHERE tipo <> 'REMITO' AND tipo <> 'PRESUPUESTO' AND idcliente = '" & cboCliente.ItemData(cboCliente.ListIndex) & "' "
    ...
    If cboTipo.Text <> "RESUMIDO" Then
        ...
        SQL = "SELECT * FROM recibosdr WHERE idcliente = '" & cboCliente.ItemData(cboCliente.ListIndex) & "' ORDER BY fecha"
...
'    calculaCtaCte
'
'    drCtaCte1.Sections("ReportHeader").Controls("rptCliente").Caption = cboCliente.Text
'
'    ActualizarDR
'    drCtaCte1.Show
